...
public class AdapterDao<T> implements InterfazDao<T> {
    ...
    private Gson g;
    public static String filePath = "jersey-service\\src\\main\\java\\Data";
    ...
    private String readFile() throws Exception {
        ...
        System.out.println("Leyendo archivo desde: " + file.getAbsolutePath());
    
        if (!file.exists()) {
            System.out.println("El archivo no existe, creando uno nuevo: " + file.getAbsolutePath());
            saveFile("[]"); // Crea un archivo vacío si no existe
        }
        ...
        System.out.println("Contenido del archivo leído: " + sb.toString()); // Mostrar el contenido leído
    ...
    private void saveFile(String data) throws Exception {
        ...
        try (FileWriter f = new FileWriter(file)) {
            f.write(data);
            f.flush();
            System.out.println("Archivo guardado correctamente con los datos: " + data); // Mostrar los datos guardados
        } catch (Exception e) {
